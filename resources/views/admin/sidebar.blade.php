        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showfoodmenu')}}">
              ...
              <span class="menu-title">Show  FoodMenu</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showreservation')}}">
              ...
              <span class="menu-title">Show Reservation</span>
            </a>
          </li>


          <li class="nav-item menu-items">
            <a class="nav-link" href="addchef">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="showchef">
              ...
              <span class="menu-title">Show chef</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showorder')}}">
              ...
              <span class="menu-title">CustomerOrders</span>
            </a>
          </li>
